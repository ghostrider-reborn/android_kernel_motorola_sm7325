...
DEFCONFIG="dubai_defconfig"

ZIPNAME="QuicksilveR-dubai-$(date '+%Y%m%d-%H%M').zip"
...
dtbo="out/arch/arm64/boot/dts/vendor/qcom/yupik-dubai-evb-overlay.dtbo"
...
elif ! git clone -q https://github.com/ghostrider-reborn/AnyKernel3 -b dubai; then
